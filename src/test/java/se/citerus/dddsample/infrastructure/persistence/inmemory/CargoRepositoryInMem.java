...
/**
 * CargoRepositoryInMem implement the CargoRepository interface but is a test class not intended for
 * usage in real application.
 *
 * <p>It setup a simple local hash with a number of Cargo's with TrackingId as key defined at
 * compile time.
 *
 * <p>
 */
public class CargoRepositoryInMem implements CargoRepository {
  ...
  public void init() throws Exception {
    ...
    final Cargo cargoXYZ =
        createCargoWithDeliveryHistory(
