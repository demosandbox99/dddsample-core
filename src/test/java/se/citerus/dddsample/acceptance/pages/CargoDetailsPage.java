...
public class CargoDetailsPage {
  ...
  public void expectOriginOf(String expectedOrigin) {
    String actualOrigin =
        driver.findElement(By.xpath("//div[@id='container']/table/tbody/tr[1]/td[2]")).getText();
  ...
  public void expectDestinationOf(String expectedDestination) {
    String actualDestination =
        driver.findElement(By.xpath("//div[@id='container']/table/tbody/tr[2]/td[2]")).getText();
  ...
  public void expectArrivalDeadlineOf(LocalDate expectedArrivalDeadline) {
    String actualArrivalDeadline =
        driver.findElement(By.xpath("//div[@id='container']/table/tbody/tr[4]/td[2]")).getText();
  ...
  public void expectRoutedOf(String routingStatus) {
    String actualRoutingStatus =
        driver.findElement(By.xpath("//div[@id='container']/p[2]/strong")).getText();
  ...
  public void expectItinerary() {
    String itineraryText =
        driver.findElement(By.xpath("//div[@id='container']/table[2]/caption")).getText();
