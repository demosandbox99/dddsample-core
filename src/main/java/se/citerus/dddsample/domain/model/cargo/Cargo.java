...
public class Cargo implements DomainEntity<Cargo> {
  ...
  public Cargo(final TrackingId trackingId, final RouteSpecification routeSpecification) {
    ...
    this.delivery = Delivery.derivedFrom(this.routeSpecification, null, HandlingHistory.EMPTY);
  }
  ...
  public void specifyNewRoute(final RouteSpecification routeSpecification) {
    ...
    Itinerary itineraryForRouting =
        this.itinerary != null && !this.itinerary.isEmpty() ? new Itinerary(this.itinerary) : null;
   ...
   * <b>asynchronously</b> since {@link se.citerus.dddsample.domain.model.handling.HandlingEvent} is
  ...
  public void deriveDeliveryProgress(final HandlingHistory handlingHistory) {
    ...
    this.delivery =
        Delivery.derivedFrom(
            routeSpecification(),
            itinerary(),
            handlingHistory.filterOnCargo(new TrackingId(this.trackingId)));
  }
