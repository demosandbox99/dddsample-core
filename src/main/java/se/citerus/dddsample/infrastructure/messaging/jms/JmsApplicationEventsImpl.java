...
public final class JmsApplicationEventsImpl implements ApplicationEvents {
  ...
  public void cargoWasHandled(final HandlingEvent event) {
    ...
    jmsOperations.send(
        cargoHandledQueue, session -> session.createTextMessage(cargo.trackingId().idString()));
  }
  ...
  public void cargoWasMisdirected(final Cargo cargo) {
    ...
    jmsOperations.send(
        misdirectedCargoQueue, session -> session.createTextMessage(cargo.trackingId().idString()));
  }
  ...
  public void cargoHasArrived(final Cargo cargo) {
    ...
    jmsOperations.send(
        deliveredCargoQueue, session -> session.createTextMessage(cargo.trackingId().idString()));
  }
