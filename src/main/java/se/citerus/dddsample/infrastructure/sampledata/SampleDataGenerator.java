...
public class SampleDataGenerator {
  private static final org.slf4j.Logger log =
      org.slf4j.LoggerFactory.getLogger(SampleDataGenerator.class);
  ...
  public void loadHibernateData(
      TransactionTemplate tt, final HandlingEventFactory handlingEventFactory) {
        ...
        new TransactionCallbackWithoutResult() {
          ...
          protected void doInTransactionWithoutResult(TransactionStatus status) {
            ...
            RouteSpecification routeSpecification =
                new RouteSpecification(HONGKONG, HELSINKI, toDate("2009-03-15"));
            ...
            RouteSpecification routeSpecification1 =
                new RouteSpecification(HANGZHOU, STOCKHOLM, toDate("2009-03-18"));
  ...
  private static Timestamp getBaseTimeStamp() {
    try {
      ...
      return new Timestamp(
          date.atStartOfDay().toEpochSecond(ZoneOffset.UTC) * 1000 - 1000L * 60 * 60 * 24 * 100);
