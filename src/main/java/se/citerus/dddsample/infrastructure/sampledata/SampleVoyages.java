...
public class SampleVoyages {
  ...
  private static Voyage createVoyage(String id, Location from, Location to) {
    return new Voyage(
        new VoyageNumber(id),
        new Schedule(List.of(new CarrierMovement(from, to, Instant.now(), Instant.now()))));
  }

  // TODO CM00[1-6] and createVoyage are deprecated. Remove and refactor tests.

  public static final Voyage v100 =
      new Voyage.Builder(new VoyageNumber("V100"), HONGKONG)
  ...
  public static final Voyage v200 =
      new Voyage.Builder(new VoyageNumber("V200"), TOKYO)
  ...
  public static final Voyage v300 =
      new Voyage.Builder(new VoyageNumber("V300"), TOKYO)
  ...
  public static final Voyage v400 =
      new Voyage.Builder(new VoyageNumber("V400"), HAMBURG)
