...
/**
 * This web service endpoint implementation performs basic validation and parsing of incoming data,
 * and in case of a valid registration attempt, sends an asynchronous message with the information
 * to the handling event registration system for proper registration.
 */
@RestController
